...
//
//import com.example.moviezip.dao.AccountDao;
//import com.example.moviezip.dao.mybatis.MybatisAccountDao;
...
//    @Autowired
//    private MybatisAccountDao mybatisAccountDao;
//
//    @Test
//    public void testUser() throws Exception{
//        System.out.println("테스트");
//
//        User user = accountDao.getUserById(3L);
//
//        TestCase.assertNotNull(user);
//        System.out.println("유저 현재 비번:"+ user.getId()+ user.getPassword());
//
//        mybatisAccountDao.updatePassword(user.getId(),"newPass");
//
//        User user1 = accountDao.getUserById(3L);
//
...
//
//        //사용자 찾기
//        User user2 =  mybatisAccountDao.findUser("kim", "mimi");
//        if (user2 != null) {
...
//
//        //사용자 닉네임 수정
//        User user3 = accountDao.getUserById(3L);
//        mybatisAccountDao.updateNickname(user.getId(), "dydy");
//        User user4 = accountDao.getUserById(3L);
//        System.out.println("변경된 유저닉네임:"+ user4.getNickname());
//
//        //중복 닉네임 체크
//        User user5 = mybatisAccountDao.existingNickname("dydy");
//        if(user5 != null) {
...
//
//        //사용자 전체 출력
//        List<User> allUser = mybatisAccountDao.findAllUser();
...
//
//        //사용자의 관심사 찾기
//        Interest interests = accountDao.findInterest(3L);
...
//
//        //사용자 취향까지 출력
//        User user10 = mybatisAccountDao.findAllUserInterest(3L);
//        System.out.println("--------------------------");
